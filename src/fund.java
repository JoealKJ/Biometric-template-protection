...
sdf = new SimpleDateFormat("yyyy-MM-dd");
 String a15=sdf.format(date);  
          ...
          v5=Integer.parseInt(rs2.getString(1))+1;
            ...
            v=st.executeUpdate("insert into transaction values('"+v5+"','"+a2+"','"+jTextField1.getText()+"','"+jTextField2.getText()+"','FundTransfer','"+a15+"')");
               ResultSet rs=st.executeQuery("select * from register where account='"+jTextField1.getText()+"'");
            if(rs.next())
            {
             v1=Integer.parseInt(rs.getString(19));
               }
              
              ResultSet rs1=st.executeQuery("select * from register where account='"+a2+"'");
            if(rs1.next()){
          v2=Integer.parseInt(rs1.getString(19));
              }    
                v5=v1+v3;
               v=st.executeUpdate("update register set amount='"+v5+"' where account='"+jTextField1.getText()+"'");
                v4=v2-v3;
            v=st.executeUpdate("update register set amount='"+v4+"' where account='"+a2+"'");
            if(v==1){
